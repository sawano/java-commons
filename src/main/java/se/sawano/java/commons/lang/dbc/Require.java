...
import se.sawano.java.commons.lang.AbstractValidate;

import java.util.Collection;
import java.util.Map;

/**
 * Utility methods for performing assertions. This class is identical to {@link se.sawano.java.commons.lang.Validate} except that the exceptions thrown when an assertion fails is of the type {@link
 * se.sawano.java.commons.lang.dbc.RequirementException}. Please see {@link se.sawano.java.commons.lang.Validate} for documentation.
 *
 * @see se.sawano.java.commons.lang.Validate
 */
public class Require {
    ...
    private static AbstractValidate<RequirementException> INSTANCE = new AbstractValidate<RequirementException>() {

        @Override
        protected IllegalArgumentRequirementException illegalArgument(final String message) {
            return new IllegalArgumentRequirementException(message);
        }

        @Override
        protected NullPointerRequirementException nullPointer(final String message) {
            return new NullPointerRequirementException(message);
        }

        @Override
        protected IndexOutOfBoundsRequirementException indexOutOfBounds(final String message) {
            return new IndexOutOfBoundsRequirementException(message);
        }

        @Override
        protected IllegalStateRequirementException illegalState(final String message) {
            return new IllegalStateRequirementException(message);
        }

        @Override
        protected IllegalArgumentRequirementException illegalArgument(final Exception e, final String message) {
            return new IllegalArgumentRequirementException(message, e);
        }
