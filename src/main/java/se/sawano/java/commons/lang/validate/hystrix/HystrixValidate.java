...
/**
 * Utility methods for performing assertions. This class is identical to {@link Validate} except that the exceptions thrown when an assertion fails is of the type {@link HystrixBadRequestException}.
 * Please see {@link Validate} for documentation.
 *
 * @see Validate
 * @see HystrixBadRequestException
 */
public class HystrixValidate {

    private HystrixValidate() {}
    ...
    private static AbstractValidate<HystrixBadRequestException> INSTANCE = new AbstractValidate<HystrixBadRequestException>() {

        @Override
        protected IllegalArgumentHystrixBadRequestException illegalArgument(final String message) {
            return new IllegalArgumentHystrixBadRequestException(message);
        }

        @Override
        protected NullPointerHystrixBadRequestException nullPointer(final String message) {
            return new NullPointerHystrixBadRequestException(message);
        }

        @Override
        protected IndexOutOfBoundsHystrixBadRequestException indexOutOfBounds(final String message) {
            return new IndexOutOfBoundsHystrixBadRequestException(message);
        }

        @Override
        protected IllegalStateHystrixBadRequestException illegalState(final String message) {
            return new IllegalStateHystrixBadRequestException(message);
        }

        @Override
        protected IllegalArgumentHystrixBadRequestException illegalArgument(final Exception e, final String message) {
            return new IllegalArgumentHystrixBadRequestException(message, e);
        }
