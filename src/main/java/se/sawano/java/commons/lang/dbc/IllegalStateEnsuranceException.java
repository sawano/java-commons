...
public class IllegalStateEnsuranceException extends EnsuranceException {
    ...
    public IllegalStateEnsuranceException(final String message) {
        super(message);
    }

    public IllegalStateEnsuranceException(final String message, final Throwable cause) {
        super(message, cause);
    }

    public IllegalStateEnsuranceException(final Throwable cause) {
        super(cause);
    }
